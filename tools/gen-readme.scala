...
process(test, "BriefIntroSection.scala")
process(test, "ConfigurationOverviewSection.scala")
process(test, "AdaptersSection.scala")
process(test, "ConvertersSection.scala")
process(test, "FieldNamingConventionsSection.scala")
